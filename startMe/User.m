...
-(id)initWithId:(NSString *)user_id is_followed:(NSString *)is_followed name:(NSString *)name
        surname:(NSString *)surname email:(NSString *)email img_profile:(NSString *)img_profile count_p:(NSString *)count_p count_fwers:(NSString *)count_fwers count_fwing:(NSString *)count_fwing tags:(NSArray *)tags {
    
    self = [super init];
    if(self) {
        self.user_id = (user_id) ? user_id : @"";
        if(is_followed==(NSString *)[NSNull null]){
            //yourself
            is_followed = @"0";
        }
    ...
    self = [self initWithId:[Utility decryptString:[dict valueForKey:@"id"]]
             ...
             img_profile:[Utility decryptString:[dict valueForKey:@"img_profile"]]
                ...
                count_fwing:[Utility decryptString:[dict valueForKey:@"count_fwing"]]
                       tags:[@"photography,diving,fishing" componentsSeparatedByString:@","]];
