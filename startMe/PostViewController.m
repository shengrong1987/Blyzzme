...
#define POST_HAVE_IMAGE (_post.arrImage && [_post.arrImage count] > 0)
...
-(NSString *)tableView:(UITableView *)tableView titleForHeaderInSection:(NSInteger)section {
    if(section == 0) return @"";
    int tot_comments = (int)[arrComments count];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (IS_TABLE_HASHTAG) {
        ...
        if(isTypeHashtag) {
            ...
            Followed *f = [[Followed alloc] initWithDictonary:dict];
    ...
    if(indexPath.section == 0) {
        if(indexPath.row == 0) {
            ...
            if(POST_HAVE_IMAGE) {
                if(_post.image) {
                    ...
                    dispatch_async(queue, ^(void) {
                        ...
                        _post.image = [Utility getCachedImageFromPath:[URL_SERVER stringByAppendingString:PATH_IMAGES_POSTS] withName:(NSString *)[_post.arrImage objectAtIndex:0]];
            ...
            CGSize textSize = [strInfo sizeWithMyFont:[UIFont systemFontOfSize:11.0f] constrainedToSize:CGSizeMake(300, 20) lineBreakMode: NSLineBreakByWordWrapping];
            ...
            int offset = (_post.tot_comments > 0 || _post.tot_likes > 0 || _post.tot_dislikes > 0) ? 15+BUTTON_INFO_HEIGHT : 15;
            ...
            [btLike setHighlighted:_post.like_me];
            [btLike setImage:(_post.like_me?[UIImage imageNamed:@"btn_up_on.png"]:[UIImage imageNamed:@"btn_up.png"])];
            ...
            [btDislike setHighlighted:_post.dislike_me];
            [btDislike setImage:(_post.dislike_me?[UIImage imageNamed:@"btn_down_on.png"]:[UIImage imageNamed:@"btn_down.png"])];
...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 0) {
        ...
        if (indexPath.row == 0) {
            ...
            textSize = [descr sizeWithMyFont:[UIFont systemFontOfSize:13.0f] constrainedToSize:CGSizeMake(DESCR_WIDTH, 20000) lineBreakMode: NSLineBreakByWordWrapping];
    ...
    CGSize textSize = [descr sizeWithMyFont:[UIFont systemFontOfSize:13.0f] constrainedToSize:CGSizeMake(DESCR_WIDTH_COMMENT, 20000) lineBreakMode: NSLineBreakByWordWrapping];
            ...
            if([response isEqualToString:@"-1"]) {
                ...
                if([request.method isEqualToString:SERVICE_COMMENT]) {
                    ...
                    if(!is_partial_get)
                        ...
                        _post.tot_comments += (int)[comments count];
                        
                    int lastArrLength = (int)[arrComments count];
                        ...
                        _post = [[Post alloc] initWithId:[Utility decryptString:[post valueForKey:@"id"]]
                                            ...
                                            tot_comments:[[Utility decryptString:[post valueForKey:@"tot_comments"]] intValue]
                                              ...
                                              imgProfile:[Utility decryptString:[post valueForKey:@"img_profile"]]
                                               ...
                                               tot_dislikes:[[Utility decryptString:[post valueForKey:@"tot_dislikes"]] intValue]
                                                 dislike_me:[Utility decryptString:[post valueForKey:@"dis"]]
                                 ];
                        reloadAll = YES;
