...
- (void) adjustTextInputHeightForText:(NSString*)text animated:(BOOL)animated {
   ...
   int h1 = [text sizeWithMyFont:_textView.font].height;
   int h2 = [text sizeWithMyFont:_textView.font constrainedToSize:CGSizeMake(_textView.frame.size.width - 16, 170.0f) lineBreakMode:NSLineBreakByWordWrapping].height;
