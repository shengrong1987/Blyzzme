...
-(id)initWithId:(NSString *)post_id title:(NSString *)title 
    ...
    if(self) {
        ...
        self.title = title;
        self.descr = descr;
        self.arrImage = [image isEqualToString:@""]?nil:[image componentsSeparatedByString:@","];
        ...
        self.tot_dislikes = tot_dislikes;
        self.dislike_me = ![dislike_me isEqualToString:@""];
