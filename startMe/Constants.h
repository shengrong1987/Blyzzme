...
#define URL_SERVER @"http://www.blyzzme.com/"
...
//Title app
#define APP_TITLE @"Blyzzme"    //Name of the app (appears in the navigation's bar of the main view)
...
//NavBar Colors & Font
#define NAVBAR_BACKGROUND_COLOR [UIColor colorWithRed:129.0/255.0 green:183.0/255.0 blue:64.0/255.0 alpha:1.0]       //The color of the background of all navbars
...
#define INDEX_OF_CONTACELIST 2
#define INDEX_OF_NOTIFICATIONS 3
#define INDEX_OF_PROFILE 4

#define BAR_BUTTON_WIDTH 65;
#define BAR_BUTTON_HEIGHT 50;
