...
-(void)viewDidLoad {
    ...
    */
    ...
    self.focusView = [[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"focus-crosshair"]] autorelease];
...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info {
    ...
    if (outputImage) {
        if(staticPicture) staticPicture = nil; [staticPicture release];
...
-(void) dealloc {
    ...
    [blurToggleButton release];
    [flashToggleButton release];
    [cancelButton release];
    [retakeButton release];
    [filtersToggleButton release];
    [libraryToggleButton release];
    [filterScrollView release];
    [filtersBackgroundImageView release];
    [photoBar release];
    [topBar release];
    [blurOverlayView release];
